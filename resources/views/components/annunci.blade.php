@foreach ($announcements as $annuncio)
    <div class="col mb-4 rounded-5" style="grid-auto-rows: 1fr" data-tilt data-tilt-max="5" data-tilt-reset="true" data-tilt-speed="300">
        <div class="card border border-primary rounded-5 h-100" >
            ...
            <div class="card-body ">
                ...
                <div class="border-2 mb-2 mt-2">
                    <p class="card-text mb-2 "><strong>Descrizione</strong>:<br> {{ Str::limit($annuncio->body, 50) }}</p>
            ...
            <div class="card-footer text-center border-0 "
                ...
                ">
                <a href="{{ route('announcements.show', $annuncio) }}" class="btn btn-cta p-2  m-1 mx-auto">Per saperne di
                    più</a>
            </div>
        </div>
    </div>
